            ...
            <div class="mu-gallery-content">
              ...
              <div class="mu-gallery-body" id="mixit-container">
                ...
                <div class="mu-single-gallery col-md-4 mix drink">
                  <div class="mu-single-gallery-item">
                    <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/2.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix restaurant">                  
                  <div class="mu-single-gallery-item">
                   <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/3.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix dinner">                  
                  <div class="mu-single-gallery-item">
                    <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/4.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix dinner">                  
                  <div class="mu-single-gallery-item">
                    <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/5.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix drink">                  
                  <div class="mu-single-gallery-item">
                    <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/7.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix restaurant">                  
                  <div class="mu-single-gallery-item">
                   <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/8.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
                ...
                <div class="mu-single-gallery col-md-4 mix dessert">                  
                  <div class="mu-single-gallery-item">
                    <figure class="mu-single-gallery-img">
                      <a href="#"><img alt="img" src="{{asset('food_asset/assets/img/gallery/small/9.jpg')}}"></a>
                    </figure>
                    <div class="mu-single-gallery-info">
